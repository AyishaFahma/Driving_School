...
// This defines the shape of a single dashboard object — basically one record or one row of dashboard info.
type Dashboard = {
  id: string;
  // expiry_datas:string;
  message: string;
...
// This defines a more complex data structure — probably the overall dashboard API response that holds multiple parts.
// It’s not one record — it’s like a container of dashboard sections
