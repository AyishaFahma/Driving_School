...
const Create: React.FC<CreateProps> = ({
  ...
  const fetchSearchAdmission = async () => {
    try {
      ...
      if (data.success) {
        setSearchAdmissionData(data.data.admission_details || []);
  ...
  const handleSelectAdmission = (admission: Admission) => {
    setSelectedAdmission(admission.text);
    setSearchAdmission("");
                          ...
                          <div className="absolute z-10 mt-1 w-full rounded-md border border-gray-300 bg-white shadow-lg dark:border-navy-600 dark:bg-navy-700">
                            ...
                            <ul className="max-h-48 overflow-y-auto hide-scrollbar">
                              {filteredAdmission.length > 0 ? (
                                filteredAdmission.map((admission) => (
                                  <li
                                    key={admission.id}
                    ...
                    <div className="w-full max-w-3xl mx-auto space-y-6">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <div
                            className={`border-2 rounded-lg flex items-center justify-center h-42 w-42 sm:h-40 sm:w-40 ${signaturePreview
                              ? "border-gray-300"
                              : "border-blue-500"
                              }`}
                          >
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 mt-2">
                      <div className="block">
                        ...
                        <div>
                          ...
                          <div
                            className={`border-2 rounded-lg flex items-center justify-center h-42 w-42 sm:h-40 sm:w-40 ${documentPreview
                              ? "border-gray-300"
                              : "border-blue-500"
                              }`}
                          >
